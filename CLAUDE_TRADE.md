...
22. [MANAGEMENT] Elke GEVULDE trade krijgt verplicht actief beheer, niet alleen entry/SL/TP: (a) verplaats de stop naar BREAK-EVEN zodra de trade +1R staat of TP1 nadert; (b) neem PARTIAL winst op TP1 (≈1/3) en laat de rest risicovrij lopen met een trailing stop. Reden (eigen data): de long 0.15 @ 4399.96 (13-08) stond op +$137, kwam terug en werd −1R omdat de stop niet naar BE ging — een BE-stop had er een scratch van gemaakt; en over onze 7 trades is de gerealiseerde gem. winst exact +1,00R terwijl de setups 2-3R-doelen hadden — we lieten geen enkele runner lopen én gaven winst terug. Winnaars beschermen en laten lopen is de grootste, meest fixbare hefboom voor de expectancy — niet meer of "betere" entries.
23. [PSYCH/TIMING] Neem GEEN verse trade (a) tijdens een breaker-halt of na 2+ verliezen op rij, (b) in de vrijdagmiddag→weekend-close-zone (gap-risico), of (c) als blinde ondiepe limit in een dalende pullback (vallend mes). Na een verliesreeks: STOP tot een nieuwe sessie/dag een schoon, eenduidig beeld geeft — niet door de halt heen traden. Reden (eigen data): 12-13/08 forceerden we longs na de 4448-dubbeltop-rejection, dwars door de halt, richting het weekend → 4 verliezen op rij. Niet-traden is een geldige positie; kwaliteit boven kwantiteit verhoogt de win rate, meer trades verlagen 'm.
24. [HONESTY/SELECTIVITY] "Alleen of bijna alleen winnende trades" bestaat niet en najagen = OVERFITTING — door eigen deep-research (13-08) bevestigd als de #1 faaloorzaak van trading-bots; win rate is een afleiding, optimaliseer op EXPECTANCY / profit factor / max drawdown. Van onze 7 trades waren 5 verliezen de counter-range-shorts van 29-30/07 die risk_guard nu al blokkeert — de "te veel verlies"-indruk komt grotendeels van één reeds-gefixte fout op een piepklein sample (over-fit niet op 7 trades). De enige eerlijke hefbomen voor minder verlies: strikte selectiviteit (alleen A/B aan een schone rand, trend-mee, momentum-mee), bevestigings-entry i.p.v. blinde limit, verplicht BE+partial (R22), en de breaker respecteren (R23). Een systeem/verkoper dat belooft "bijna nooit te verliezen" is een rode vlag, geen doel.
